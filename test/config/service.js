...
module.exports = function ( ) {
  var sqsBrokerFacade = new SqsBrokerFacade({ region: process.env.AWS_REGION, accessKeyId: process.env.AWS_ACCESSKEYID, secretAccessKey: process.env.AWS_SECRETACCESSKEY, serviceDomain: 'service-test', serviceLane: 'singleton' });
  ...
  service.addRunner('error-yes-acknowledge-implicit', ( params ) => {
    ...
    throw new Error( 'Acknowledge' );

  });

  service.addRunner('throw-error', ( params ) => {

    throw new Error( 'See error' );

  });

  service.addResolver('throw-error', ( params ) => {
